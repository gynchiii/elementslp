<template>
  <q-page class=" bg-black" style="overflow-x: hidden ; overflow-y: hidden ">
    ...
    <subtitle class="text-h5 text-grey-5 text-white text-center texxt"> porque ter uma cadeira ? <br> quando se pode ter um trono ! </subtitle>
      <h1 class="text-purple-2 text-bold large-screen-only texxt">ELEMENTS</h1>
      <h2 class="text-purple-2 small-screen-only texxt">ELEMENTS</h2>
    </q-parallax>
    </div>
  </div>
...
Bordado no assento 
  ...
  <a style="text-decoration: none;" target="_blank" href="https://wa.me/554833746010" class="large-screen-only texxt text-h4 q-pa-md text-white"> quero falar com consultor  </a>
   ...
   <h4 class="text-center texxt text-blue">Blue chairs</h4>
    ...
    <h2 class="texxt small-screen-only text-center text-red">Linha. Ignis</h2>
      <div class="flex flex-center">
      <form  action="https://wa.me/554833746010" target="_blank">
      <q-btn
      size="35px"
  ...
  <a style="text-decoration: none;" target="_blank" href="https://wa.me/554833746010" class="large-screen-only texxt text-h4 q-pa-md text-white"> quero falar com consultor  </a>
   ...
   <h4 class="text-center texxt text-red">Red chairs</h4>
    ...
    <h2 class="texxt small-screen-only text-center text-white">Linha. Aer</h2>
      <div class="flex flex-center">
      <form action="https://wa.me/554833746010" target="_blank">
      <q-btn
      size="35px"
   ...
   <h4 class="text-center texxt text-white">White chairs</h4>
      ...
      style="width: 100vw; height: 74vh;"
      swipeable
      class="large-screen-only bg-grey-2"
      autoplay="autoplay"
      animated
      v-model="slide5"
      thumbnails
    ...
    <h5 class="texxt2 text-bold text-center text-purple-2"> Saiba sobre nosso storytelling <br> clicando abaixo </h5>
    <div class="flex flex-center">
          <q-btn
      padding="xl"
      color="purple-3"
       ...
       <q-page-scroller expand position="top" :scroll-offset="150" :offset="[0, 0]">
          ...
          <form action="https://wa.me/554833746010" target="_black">
           ...
           <q-page-scroller reverse position="bottom-right" :scroll-offset="20" :offset="[95, 18]">
            <q-btn fab icon="keyboard_arrow_down" class="text-black" color="white" />
          </q-page-scroller>
